...
- Variable `sharepoint_version` lets you choose which version of SharePoint to install:
  - `Subscription-Latest` (default): Same as `Subscription-RTM`, then install the latest cumulative update available at the time of publishing: 23H1 / March 2023 ([KB5002375](https://support.microsoft.com/help/5002375)) for current module version `3.5.0`.
