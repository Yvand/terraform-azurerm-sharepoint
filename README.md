...
By default, virtual machines use [Basv2 series (burstable)](https://learn.microsoft.com/azure/virtual-machines/sizes/general-purpose/basv2-series), ideal for such template and much cheaper than other comparable series.  
...
You can visit <https://azure.com/e/86b0cfc2297644089cb66472f4b263be> to estimate the monthly cost of the template in the region/currency of your choice, assuming it is created using the default settings and runs 24*7.
